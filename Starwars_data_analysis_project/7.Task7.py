...
plt.title('Bar Graph of Ranking of each Star Wars movie by those who are fans of \n Star Trek (lower ranking, the better the movie)')
plt.xlabel('Star Wars movie')
plt.ylabel('Points')

plt.yticks([0,1,2,3,4,5])

plt.savefig('bargraph(watchedstartrek)_rank_each_movie.png', dpi=100)
